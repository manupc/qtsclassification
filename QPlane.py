...
dataset= Dataset('PLANE', './datasets', 'Plane_TRAIN.arff', 'Plane_TEST.arff')
resultsFile= 'QPlane_R.pkl' # None for not saving results data
dataset.shuffle()
#dataset.diff()
...
lossF= nn.CrossEntropyLoss(weight= torch.FloatTensor([1.0, 1.0, 1.5, 1.0, 1.0, 1.0, 0.75]))
"""
MaxExper= 30
