...
dataset= Dataset('OLIVEOIL', './datasets', 'OliveOil_TRAIN.arff', 'OliveOil_TEST.arff')
resultsFile= 'QOliveOil_R.pkl' # None for not saving results data
dataset.shuffle()
dataset.diff()
...
lossF= nn.CrossEntropyLoss(weight=torch.FloatTensor([1.0, 0.5, 1.0, 0.5]))
MaxExper= 30
